 ...
 * 8472.h
 *
 * idprom defintions for SFP/SFP+/SFP28 modules.
 *
 **********************************************************************/
...
#define SFF8472_CONN_MPO_1X12    0x0C
#define SFF8472_CONN_MPO_2X16    0x0D
...
#define SFF8472_CONN_MXC_2X16    0x24
#define SFF8472_CONN_CS          0x25
#define SFF8472_CONN_SN          0x26
#define SFF8472_CONN_MPO_2X12    0x27
#define SFF8472_CONN_MPO_1X16    0x28
#define SFF8472_CONN_MPO         SFF8472_CONN_MPO_1X12
...
{
    if ((idprom[3] & SFF8472_CC3_INF_1X_CU_PASSIVE) !=
        0) {
        return 1;
    }
    if ((idprom[3] & SFF8472_CC3_INF_1X_CU_ACTIVE) !=
        0) {
        return 1;
    }
    if ((idprom[3] & SFF8472_CC3_INF_1X_LX) != 0) {
        return 1;
    }
    if ((idprom[3] & SFF8472_CC3_INF_1X_SX) != 0) {
        return 1;
    }
    return 0;
}
...
{
    if ((idprom[9] & SFF8472_CC9_FC_MEDIA_SM) != 0) {
        return 1;
    }
    if ((idprom[9] & SFF8472_CC9_FC_MEDIA_M5) != 0) {
        return 1;
    }
    if ((idprom[9] & SFF8472_CC9_FC_MEDIA_M6) != 0) {
        return 1;
    }
    if ((idprom[9] & SFF8472_CC9_FC_MEDIA_TV) != 0) {
        return 1;
    }
    if ((idprom[9] & SFF8472_CC9_FC_MEDIA_MI) != 0) {
        return 1;
    }
    if ((idprom[9] & SFF8472_CC9_FC_MEDIA_TP) != 0) {
        return 1;
    }
    if ((idprom[9] & SFF8472_CC9_FC_MEDIA_TW) != 0) {
        return 1;
    }
    return 0;
}
...
_sff8472_fc_media_mm (const uint8_t *idprom)
{
    ...
    if (((idprom[9] & SFF8472_CC9_FC_MEDIA_M5) != 0)
        && ((idprom[9] & SFF8472_CC9_FC_MEDIA_M6) == 0)) {
        return 1;
    }
    if (((idprom[9] & SFF8472_CC9_FC_MEDIA_M5) == 0)
        && ((idprom[9] & SFF8472_CC9_FC_MEDIA_M6) != 0)) {
...
_sff8472_tech_fc (const uint8_t *idprom)
{
    ...
    if ((idprom[7] & SFF8472_CC7_FC_TECH_LC) != 0) {
        return 1;
    }
    if ((idprom[7] & SFF8472_CC7_FC_TECH_SA) != 0) {
        return 1;
    }
    if ((idprom[8] & SFF8472_CC8_FC_TECH_EL) != 0) {
        return 1;
    }
    if ((idprom[8] & SFF8472_CC8_FC_TECH_LL) != 0) {
        return 1;
    }
    if ((idprom[8] & SFF8472_CC8_FC_TECH_SL) != 0) {
        return 1;
    }
    if ((idprom[8] & SFF8472_CC8_FC_TECH_SN) != 0) {
        return 1;
    }
    return 0;
}
...
_sff8472_fc_speed_1g (const uint8_t *idprom)
{
    ...
    if (((idprom[10] & SFF8472_CC10_FC_SPEED_100) !=
         0)
        || ((idprom[10] & SFF8472_CC10_FC_SPEED_200) !=
            0)) {
        return 1;
    }
...
_sff8472_fc_speed_10g (const uint8_t *idprom)
{
    ...
    if (((idprom[10] & SFF8472_CC10_FC_SPEED_800) !=
         0)
        || ((idprom[10] & SFF8472_CC10_FC_SPEED_1200) !=
            0)
        || ((idprom[10] & SFF8472_CC10_FC_SPEED_1600) !=
            0)
        || ((idprom[10] & SFF8472_CC10_FC_SPEED_3200) !=
            0)) {
        return 1;
    }
...
{
    if ((idprom[8] & SFF8472_CC8_SFP_PASSIVE) != 0) {
        return 1;
    }
...
{
    if ((idprom[8] & SFF8472_CC8_SFP_ACTIVE) != 0) {
        return 1;
    }
...
static inline int
_sff8472_compliance_passive_fc (const uint8_t
                                *idprom)
{
    if (idprom[61] != 0) {
        return 0;
...
static inline int
_sff8472_compliance_passive_sff (const uint8_t
                                 *idprom)
{
    if (idprom[61] != 0) {
        return 0;
...
static inline int
_sff8472_compliance_active_fc (const uint8_t
                               *idprom)
{
    if (idprom[61] != 0) {
        return 0;
...
static inline int
_sff8472_compliance_active_sff (const uint8_t
                                *idprom)
{
    int byte = idprom[60];
...
{
    /* vendor is 'OEM' */
    if (strncmp ((char *)idprom + 20, "OEM ",
                 4) != 0) {
        return 0;
    }

    /* model reads like 'SFP-H10GB-CU...' */
    if (strncmp ((char *)idprom + 40, "SFP-H10GB-CU",
                 12) != 0) {
        return 0;
    }

    /* S/N reads like 'CSC...' */
    if (strncmp ((char *)idprom + 68, "CSC",
                 3) != 0) {
        return 0;
    }
...
_sff8472_bitrate_xge (const uint8_t *idprom)
{
    ...
    long long br = (long long) idprom[12] * 100 *
                   1000000;
...
_sff8472_media_zr (const uint8_t *idprom)
{
    ...
    /* at least 10GbE */
    if (!_sff8472_bitrate_xge (idprom)) {
        return 0;
    }
    ...
    if (_sff8472_tech_fc_ll (idprom) == 0) {
        return 0;
    }
    if (_sff8472_fc_media_sm (idprom) == 0) {
        return 0;
    }
...
_sff8472_media_srlite (const uint8_t *idprom)
{
    ...
    if (_sff8472_length_sm (idprom)) {
        return 0;
    }
    if (_sff8472_length_om1 (idprom)) {
        return 1;
    }
    if (_sff8472_length_om2 (idprom)) {
        return 1;
    }
    if (_sff8472_length_om3 (idprom)) {
        return 1;
    }
    if (_sff8472_length_om4 (idprom)) {
        return 1;
    }
    return 0;
...
static inline int
_sff8472_media_gbe_sx_fc_hack (const uint8_t
                               *idprom)
{
    if (!SFF8472_MODULE_SFP (idprom)) {
        return 0;
    ...
    if (!SFF8472_MEDIA_GBE_SX (idprom)) {
        return 0;
    }
...
static inline int
_sff8472_media_gbe_lx_fc_hack (const uint8_t
                               *idprom)
{
    if (!SFF8472_MODULE_SFP (idprom)) {
        return 0;
    ...
    if (!SFF8472_MEDIA_GBE_LX (idprom)) {
        return 0;
    }
...
_sff8472_sfp_10g_aoc (const uint8_t *idprom)
{
    ...
    if (SFF8472_MEDIA_GBE_CX (idprom)) {
        return 0;
    }
    if (SFF8472_MEDIA_GBE_T (idprom)) {
        return 0;
    }
    if (SFF8472_MEDIA_CBE_LX (idprom)) {
        return 0;
    }
    if (SFF8472_MEDIA_CBE_FX (idprom)) {
        return 0;
    }
    ...
    if (_sff8472_compliance_passive_sff (idprom)) {
        return 0;
    }
    ...
    if (!_sff8472_length_cu (idprom)) {
        return 0;
    }
    if (_sff8472_length_cu (idprom) > 30) {
        return 0;
    }
 ...
 */
static inline int
_sff8472_sfp_10g_aoc_length (const uint8_t
                             *idprom)
{
    /* module should be sfp */
    if (!SFF8472_MODULE_SFP (idprom)) {
    ...
    if (_sff8472_length_sm (idprom) > 0) {
        return -1;
    }
    if (_sff8472_length_om1 (idprom) > 0) {
        return -1;
    }
    if (_sff8472_length_om2 (idprom) > 0) {
        return -1;
    }
    if (_sff8472_length_om3 (idprom) > 0) {
        return -1;
    }
...
_sff8472_media_sfp28_sr (const uint8_t *idprom)
{
    ...
    if (idprom[36] == SFF8472_CC36_100G_25G_SR) {
        return 1;
    }
...
_sff8472_media_sfp28_lr (const uint8_t *idprom)
{
    ...
    if (idprom[36] == SFF8472_CC36_100G_25G_LR) {
        return 1;
    }

...
static inline int
_sff8436_length_copper_active (const uint8_t
                               *idprom)
{
    return idprom[146];
}
 ...
 */
static inline int
_sff8436_qsfp_40g_sr2_bidi_pre (const uint8_t
                                *idprom)
{
    ...
    if (SFF8436_MEDIA_XGE_LRM (idprom)) {
        return 0;
    }
    if (SFF8436_MEDIA_XGE_LR (idprom)) {
        return 0;
    }
    if (SFF8436_MEDIA_XGE_SR (idprom)) {
        return 0;
    }
    if (SFF8436_MEDIA_40GE_CR4 (idprom)) {
        return 0;
    ...
    if (_sff8436_wavelength (idprom) != 850) {
        return 0;
    }

    /* make sure it reports a MM cable length */
    if (_sff8436_length_sm (idprom) > 0) {
        return 0;
    }
     ...
     */
    long long br = (long long) idprom[140] * 100 *
                   1000000;
    if ((br >= 20LL * 1000 * 1000000) &&
        (br < 40LL * 1000 * 1000000)) {
        return 1;
    }
    return 0;
 ...
 */
static inline int
_sff8436_qsfp_40g_sr4_aoc_pre (const uint8_t
                               *idprom)
{
    /* module should be qsfp */
    if (!SFF8436_MODULE_QSFP_PLUS (idprom)
    ...
    if (idprom[130] != SFF8436_CONN_NONE) {
        return 0;
    }
 ...
 */
static inline int
_sff8436_qsfp_40g_aoc_breakout (const uint8_t
                                *idprom)
{
    /* module should be qsfp */
    if (!SFF8436_MODULE_QSFP_PLUS (idprom)
    ...
    if (_sff8436_length_om1 (idprom) > 0) {
        return 0;
    }
    if (_sff8436_length_om2 (idprom) > 0) {
        return 0;
    }
    if (_sff8436_length_om3 (idprom) > 0) {
        return 0;
    }
 ...
 */
static inline int
_sff8436_qsfp_40g_aoc_length (const uint8_t
                              *idprom)
{
    /* module should be qsfp */
    if (!SFF8436_MODULE_QSFP_PLUS (idprom)

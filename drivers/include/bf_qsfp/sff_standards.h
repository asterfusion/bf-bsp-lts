...
#include <bf_qsfp/8472.h>
#include <bf_qsfp/8436.h>
#include <bf_qsfp/8636.h>
...
typedef uint8_t sff_connector_type_t;
...
/** Enum names. */
const char *sff_media_type_name (sff_media_type_t
                                 e);

/** Enum values. */
int sff_media_type_value (const char *str,
                          sff_media_type_t *e, int substr);

/** Enum descriptions. */
const char *sff_media_type_desc (sff_media_type_t
                                 e);

/** Enum descriptions. */
const char *sff_connector_type_name (
    sff_connector_type_t e);
...
/** Enum names. */
const char *sff_module_caps_name (
    sff_module_caps_t e);

/** Enum values. */
int sff_module_caps_value (const char *str,
                           sff_module_caps_t *e, int substr);

/** Enum descriptions. */
const char *sff_module_caps_desc (
    sff_module_caps_t e);
...
/** Enum names. */
const char *sff_module_type_name (
    sff_module_type_t e);

/** Enum values. */
int sff_module_type_value (const char *str,
                           sff_module_type_t *e, int substr);

/** Enum descriptions. */
const char *sff_module_type_desc (
    sff_module_type_t e);
...
/** Enum values. */
int sff_sfp_type_value (const char *str,
 ...
 */
sff_sfp_type_t sff_sfp_type_get (const uint8_t
                                 *idprom);
 ...
 * @param idprom The SFF idprom.
 */
sff_module_type_t sff_module_type_get (
    const uint8_t *idprom);

/**
 * @brief Determine the SFF Media type (from the idprom data)./
 * @param idprom The SFF idprom.
 */
sff_media_type_t sff_media_type_get (
 ...
 * @returns < 0 on error.
 */
int sff_module_caps_get (sff_module_type_t mt,
                         uint32_t *caps);
 ...
 */
int sff_eeprom_parse (sff_eeprom_t *rv,
                      uint8_t *eeprom);
 ...
 */
int sff_eeprom_parse_file (sff_eeprom_t *rv,
                           const char *fname);
 ...
 */
int sff_eeprom_validate (sff_eeprom_t *info,
                         int verbose);
 ...
 */
int sff_info_init (sff_info_t *pinfo,
                   sff_module_type_t type,
...
#include <bf_qsfp/dom.h>
#include <bf_qsfp/sff_db.h>
